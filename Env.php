...
class Env
{
    ...
    public const HOST_ADDRESS = "https://1e644be61e9f.ngrok-free.app"; // For tesing http://localhost
    public const API_HOST = "0.0.0.0";
    public const API_PORT = "1978"; // why 1978? Mums Birthday
    public const API_BASE_URL = "https://1e644be61e9f.ngrok-free.app/api/"; // For testing http://localhost:1978
