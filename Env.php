...
class Env
{
    ...
    public const HOST_ADDRESS = "https://sparkonics.iitp.ac.in"; // For tesing http://localhost
    public const API_HOST = "0.0.0.0";
    public const API_PORT = "1978"; // why 1978? Mums Birthday
    public const API_BASE_URL = "https://sparkonics.iitp.ac.in"; // For testing http://localhost:1978
