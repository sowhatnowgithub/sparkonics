...
const Navbar = () => {
  ...
  return (
      <nav>
          ...
          <div className={clsx('hamburger', showSidenav && 'hamburger-toggled')} data-menu="1" onClick={() => setShowSidenav(!showSidenav)}>
              <div className="icon-left"></div>
              <div className="icon-right"></div>
          </div>
          
          <div className={clsx('options-mobile-wrapper', showSidenav && 'options-mobile-shown')} onClick={onClickSidenav}>
