    ...
    return (
        <div>
            <FlexBox justifyEnd fullWidth>
                <Button onClick={() => setShowCreate(true)} variant={"filled"}>Add event</Button>
            </FlexBox>
            ...
            <table className={"modify-events-table"}>
                ...
                {events.map(event => (
                    <tr>
                        <td>{event.id}</td>
                        <td>{event.name}</td>
                        <td>{formatIST(event.startTime)}</td>
                        <td>{formatIST(event.endTime)}</td>
                        <td className={'table-control'} onClick={() => setModifying(event)}>[modify]</td>
                        <td
